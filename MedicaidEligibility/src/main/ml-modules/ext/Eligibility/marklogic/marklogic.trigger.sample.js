...
const decisionService = require("<Replace with Your Path>/decisionServiceBundle.js");
...
xdmp.documentInsert(resultUri, result, {
    "collections": ["replace with your collection name", uri],
